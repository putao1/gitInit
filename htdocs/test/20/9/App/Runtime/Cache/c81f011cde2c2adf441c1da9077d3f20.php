...
<table width="405" border="1" cellpadding="1" cellspacing="1" bgcolor="#99CC33" bordercolor="#FFFFFF">
 ...
 <?php if(is_array($select)): foreach($select as $key=>$user): ?><tr class="content">
    ...
    <td bgcolor="#FFFFFF" width="289"> <input type="hidden" name="id" id="hiddenField" value="<?php echo ($user["id"]); ?>" /><input name="user" type="text" id="user" size="20" value="<?php echo ($user["user"]); ?>" /></td>
    </tr>
  <tr class="content">
    <td bgcolor="#FFFFFF" class="right">密码：</td>
    <td bgcolor="#FFFFFF"><input name="pass" type="password" id="pass" size="20" value="<?php echo ($user["pass"]); ?>" />
     </td>
    </tr>
  <tr class="content">
    <td bgcolor="#FFFFFF" class="right">&nbsp;地址：</td>
    <td bgcolor="#FFFFFF">&nbsp;
      <input name="address" type="text" id="address" size="30" value="<?php echo ($user["address"]); ?>" />
    </td>
    </tr>
  <tr class="content">
