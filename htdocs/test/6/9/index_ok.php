...
<table width="765" height="229" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
	...
	<table width="88%"  border="0" cellspacing="-2" cellpadding="-2">
                        ...
                        <tr>
                            <td width="18%" height="22" align="right"><span class="style4">username</span></td>
                            <td width="82%" align="left" class="style4">&nbsp;<?php echo $_POST[recuser]; ?></td>
                        </tr>
                        <tr>
                            <td height="22" align="right"><span class="style4">address</span></td>
                            <td height="28" align="left" class="style4">&nbsp;<?php echo $_POST[address];?></td>
                        </tr>
                        <tr>
                            <td height="22" align="right"><span class="style4">postcode</span></td>
                        ...
                        <tr>
                          <td height="22" align="right" class="style4" style="padding-left:10px">mtel</td>
                          <td align="left" class="style4">&nbsp;<?php echo $_POST[mtel];?></td>
                        </tr>
                        <tr>
                          <td height="22" align="right" class="style4" style="padding-left:10px">gtel</td>
