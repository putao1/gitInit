...
function check(form){
	if(form.txt_keyword.value==""){
		alert("ÇëÊäÈë²éÑ¯¹Ø¼ü×Ö!");form.txt_keyword.focus();return false;
	}
form.submit();
}
</script>
			...
			<table width="626" height="100%" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td height="257" align="center" valign="top" background="images/image_08.gif"><table width="600" height="271"  border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td height="22" align="center" valign="top" class="word_orange"><strong>±à¼­¹«¸æÐÅÏ¢</strong></td>
                  </tr>
                  <tr>
...
&nbsp;
        <input type="submit" name="Submit" value="ËÑË÷" onClick="return check(form)">
                          </form></td>
                        </tr>
                      </table>
                      <table width="550" border="1" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF" bgcolor="#999999">
                      <tr align="center" bgcolor="#f0f0f0">
                        <td width="214">¹«¸æ±êÌâ</td>
                        <td width="271">¹«¸æÄÚÈÝ</td>
                        <td width="47">±à¼­</td>
                      </tr>
					<?php
					$conn=mysql_connect("localhost","root","root") or die("Êý¾Ý¿â·þÎñÆ÷Á¬½Ó´íÎó".mysql_error());
					mysql_select_db("db_database18",$conn) or die("Êý¾Ý¿â·ÃÎÊ´íÎó".mysql_error());
					...
					if(!$row){
					echo "<font color='red'>ÔÝÎÞ¹«¸æÐÅÏ¢!</font>";
					}
					do{
					?>
                      <tr bgcolor="#FFFFFF">
